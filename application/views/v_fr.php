...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-117635723-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-117635723-1');
	</script>
</head>
<body>
	<section id="principal">
	    <div class="section">
			...
			<div class="mdl-container-question">
        		...
        		<div class="chat">
        			<a href="https://www.sap.com/france/products/business-one.html" target="_blank"><img src="<?php echo RUTA_IMG?>chat.png"><label>Dialoguer avec nous</label></a>
        		</div>
			            			...
			            			<div class="row">
			            				<div class="col-xs-12">
			            					<div class="mdl-select">
			            						<select class="selectpicker" id="facturacion" name="facturacion" title="Sélectionner" onchange="selectFacturacion(this.id)">
