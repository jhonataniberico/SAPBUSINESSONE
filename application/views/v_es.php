            ...
            <div class="modal-content">
                <div class="mdl-card" >
				    ...
				    <div class="mdl-card__supporting-text">
						...
						<strong class="m-b-15">c. You may withdraw your consent with respect to any or both of the above cases under this section 4. at any time. Please direct any such request to <a href="mailto:webmaster@sap.com">webmaster@sap.com</a> .</strong>
						...
						<label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect js-label" for="checkbox-3">
							...
							<span class="mdl-checkbox__label f-s-14">Would you like to receive additional information on SAP products and services along with information related to this inquiry? By checking this box, you agree that your contact details will be used by <SAP Business Entity> in accordance with the SAP Marketing Consent Statement.</span>
						</label>
						<label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect js-label" for="checkbox-2">
							<input type="checkbox" id="checkbox-2" class="mdl-checkbox__input">
							<span class="mdl-checkbox__label f-s-14">I agree that SAP may share the information I have provided hereunder with the SAP group in order that that they also may send additional marketing-related communications to me.</span>
						</label>
					</div>
